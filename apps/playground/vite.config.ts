...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      '@republicroad/jdm-editor': fileURLToPath(new URL('../../packages/jdm-editor/src/index.ts', import.meta.url)),
      '@republicroad/jdm-appshell': fileURLToPath(new URL('../../packages/appshell/src/index.ts', import.meta.url)),
    },
  },
  optimizeDeps: {
